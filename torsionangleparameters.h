#ifndef TORSIONANGLEPARAMETERS_H
#define TORSIONANGLEPARAMETERS_H
...
class TorsionAngleParametersTab : public QWidget
{
    Q_OBJECT
public:
    explicit TorsionAngleParametersTab(QWidget *parent = nullptr);
...
#endif // TORSIONANGLEPARAMETERS_H
