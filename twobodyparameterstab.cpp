...
TwoBodyParametersTab::TwoBodyParametersTab(QWidget *parent) : QWidget(parent)
{
 ...
 */
void TwoBodyParametersTab::construct_label_names() {
    this->label_names.push_back("De_s if_bond");
    this->label_names.push_back("De_p if_bond");
    this->label_names.push_back("De_pp if_bond");
    this->label_names.push_back("p_be1");
    this->label_names.push_back("p_bo5");
    this->label_names.push_back("v13cor");
    this->label_names.push_back("p_bo6");
    this->label_names.push_back("p_ovun1");
    this->label_names.push_back("p_be2");
    this->label_names.push_back("p_bo3");
    this->label_names.push_back("p_bo4");
    this->label_names.push_back("Not used");
    this->label_names.push_back("p_bo1");
    this->label_names.push_back("p_bo2");
    this->label_names.push_back("ovc");
    this->label_names.push_back("Not used");
}
