...
ValenceAngleParametersTab::ValenceAngleParametersTab(QWidget *parent) : QWidget(parent)
{
 ...
 */
void ValenceAngleParametersTab::construct_label_names() {
    this->label_names.push_back("theta_0");
    this->label_names.push_back("p_val1");
    this->label_names.push_back("p_val2");
    this->label_names.push_back("p_coal");
    this->label_names.push_back("p_val17");
    this->label_names.push_back("p_pen1");
    this->label_names.push_back("p_val4");
}
