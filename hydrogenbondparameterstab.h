#ifndef HYDROGENBONDPARAMETERSTAB_H
#define HYDROGENBONDPARAMETERSTAB_H
...
class HydrogenBondParametersTab : public QWidget
{
    Q_OBJECT
public:
    explicit HydrogenBondParametersTab(QWidget *parent = nullptr);
...
#endif // HYDROGENBONDPARAMETERSTAB_H
