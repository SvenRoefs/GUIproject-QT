#ifndef VALENCEANGLEPARAMETERS_H
#define VALENCEANGLEPARAMETERS_H
...
class ValenceAngleParametersTab : public QWidget
{
    Q_OBJECT
public:
    explicit ValenceAngleParametersTab(QWidget *parent = nullptr);
...
#endif // VALENCEANGLEPARAMETERS_H
