...
HydrogenBondParametersTab::HydrogenBondParametersTab(QWidget *parent) : QWidget(parent)
{
 ...
 */
void HydrogenBondParametersTab::construct_label_names() {
    this->label_names.push_back("r0_hb");
    this->label_names.push_back("p_hb1");
    this->label_names.push_back("p_hb2");
    this->label_names.push_back("p_hb3");
}
