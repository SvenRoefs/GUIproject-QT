#ifndef TWOBODYPARAMETERSTAB_H
#define TWOBODYPARAMETERSTAB_H
...
class TwoBodyParametersTab : public QWidget
{
    Q_OBJECT
public:
    explicit TwoBodyParametersTab(QWidget *parent = nullptr);
