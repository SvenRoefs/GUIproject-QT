...
TorsionAngleParametersTab::TorsionAngleParametersTab(QWidget *parent) : QWidget(parent)
{
 ...
 */
void TorsionAngleParametersTab::construct_label_names() {
    this->label_names.push_back("v1");
    this->label_names.push_back("v2");
    this->label_names.push_back("v3");
    this->label_names.push_back("p_tor1");
    this->label_names.push_back("p_cot1");
}
